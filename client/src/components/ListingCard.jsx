...
import { BadgeCheck, LineChart, MapPin, UserIcon } from "lucide-react";
      ...
      <div className="p-5 pt-8">
        ...
        <div className="flex flex-wrap justify-between max-w-lg items-center gap-3 my-5">
            <div className="flex items-center text-sm text-gray-600">
                <UserIcon className="size-6 mr-1 text-gray-400"/>
            ...
            {listing.engagement_rate &&(
                <div className="flex items-center text-sm text-gray-600">
                    ...
                    <span className="text-lg font-medium text-slate-800 mr-1.5">{listing.engagement_rate} % engagement</span>
                </div>
            )}
        </div>
        {/* Tags & loaction */}
       ...
       <div className="flex items-center justify-between">
        <div className="flex items-baseline">
            <span className="text-2xl font-medium text-slate-800">{currency}{listing.price.toLocaleString()}</span>
        </div>
