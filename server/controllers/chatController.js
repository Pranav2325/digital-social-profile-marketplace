//contoller for getting chat (creating if not exist)
...
//controlling for geeting all chats for user
export const getAllUserChats = async (req, res) => {
  try {
    ...
    if (!chats || chats.length === 0) {
      return res.status(500).json({ chats: [] });
    }
...
//controller for adding message in chat
